...
## Bundle Dependency Architecture

```
┌─────────────────────────────────────────────────────────────────────────┐
│                         org.adempiere.base                              │
│                       (iDempiere Core Framework)                        │
│                                                                         │
...
**❌ If ai.deps required aws.provider (WRONG):**
```
ai.deps → aws.provider → org.adempiere.base
ai.core → ai.deps → aws.provider (CIRCULAR!)
ai.core → aws.provider (CIRCULAR!)
```
