package com.cloudempiere.ai.purchasing.boundary;

import java.util.Collections;
import java.util.Set;

/**
 * Purchasing domain boundary - restricts AI access to purchasing-related tables only.
 *
 * <p>This class enforces security boundaries for the Purchasing domain agent,
 * ensuring it can only read/write tables relevant to purchasing operations.</p>
 *
 * <p><b>Architecture Layer:</b> Domain Boundary Layer (Purchasing)</p>
 ...
 * @version 1.0.0
 */
public class PurchasingDomainBoundary {

    /**
     * Tables that purchasing agents can READ.
     *
     * <p><b>Allowed:</b></p>
     * <ul>
     *   <li>C_Order, C_OrderLine - Purchasing orders</li>
    ...
    /**
     * Tables that purchasing agents can WRITE (create/update).
     *
     * <p><b>Allowed:</b></p>
     * <ul>
    ...
    /**
     * Actions that purchasing agents can perform.
     *
     * <p><b>Allowed:</b></p>
     * <ul>
    ...
    /**
     * Validates that the table can be read by purchasing agents.
     *
    ...
    public static void validateReadTable(String tableName) {
        if (!READ_TABLES.contains(tableName)) {
            throw new SecurityException(
                String.format("[Purchasing Domain] Table '%s' not accessible for reading. " +
    ...
    /**
     * Validates that the table can be written by purchasing agents.
     *
     * @param tableName the table to validate
    ...
    public static void validateWriteTable(String tableName) {
        if (!WRITE_TABLES.contains(tableName)) {
            throw new SecurityException(
                String.format("[Purchasing Domain] Table '%s' not writable. " +
    ...
    /**
     * Validates that the action can be performed by purchasing agents.
     *
    ...
    public static void validateAction(String action) {
        if (!ALLOWED_ACTIONS.contains(action)) {
            throw new SecurityException(
                String.format("[Purchasing Domain] Action '%s' not allowed. " +
