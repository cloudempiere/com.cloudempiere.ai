...
-- Dec 3, 2025, 11:47:44 PM CET
INSERT INTO t_alter_column values('aig_provider','AD_User_ID','NUMERIC(10)',null,'NULL')
;

-- Dec 3, 2025, 11:47:44 PM CET
ALTER TABLE AIG_Provider ADD COLUMN IsDefault CHAR(1) DEFAULT 'N' CHECK (IsDefault IN ('Y','N'))
;
