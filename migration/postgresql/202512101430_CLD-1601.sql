...
SELECT 800100, 0, 0, 'Y', NOW(), 100, NOW(), 100,
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800101, 0, 0, 'Y', NOW(), 100, NOW(), 100,
    'AIG_Error_Timeout', 'E',
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800102, 0, 0, 'Y', NOW(), 100, NOW(), 100,
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800103, 0, 0, 'Y', NOW(), 100, NOW(), 100,
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800104, 0, 0, 'Y', NOW(), 100, NOW(), 100,
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800105, 0, 0, 'Y', NOW(), 100, NOW(), 100,
...
INSERT INTO AD_Message (AD_Message_ID, AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,
    Value, MsgType, MsgText, EntityType, AD_Message_UU)
SELECT 800106, 0, 0, 'Y', NOW(), 100, NOW(), 100,
    'AIG_Error_Generic', 'E',
