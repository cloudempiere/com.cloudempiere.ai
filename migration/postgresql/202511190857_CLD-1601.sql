...
-- Nov 19, 2025, 9:00:06 AM CET
CREATE SEQUENCE AIG_QUERYAUDIT_SQ INCREMENT 1 MINVALUE 1000000 MAXVALUE 2147483647 START 1000000
;
...
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGContextType VARCHAR(60) DEFAULT NULL 
;

-- Nov 19, 2025, 9:09:45 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGErrorMessage VARCHAR(2000) DEFAULT NULL 
;

-- Nov 19, 2025, 9:09:50 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGExecutionTimeMs NUMERIC(10) DEFAULT NULL 
;

-- Nov 19, 2025, 9:09:55 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGPermissionDeniedReason VARCHAR(1000) DEFAULT NULL 
;

-- Nov 19, 2025, 9:09:59 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGQueryPurpose VARCHAR(255) DEFAULT NULL 
;

-- Nov 19, 2025, 9:10:04 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGQuerySQL TEXT NOT NULL
;

-- Nov 19, 2025, 9:10:08 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGRowCount NUMERIC(10) DEFAULT NULL 
;

-- Nov 19, 2025, 9:10:12 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGSecuredSQL TEXT DEFAULT NULL 
;

-- Nov 19, 2025, 9:10:16 AM CET
ALTER TABLE AIG_QueryAudit ADD COLUMN AIGTablesAccessed VARCHAR(2000) DEFAULT NULL 
;
