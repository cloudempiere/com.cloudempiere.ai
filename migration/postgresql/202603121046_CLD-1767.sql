...
-- Mar 12, 2026, 10:47:21 AM CET
ALTER TABLE AIG_Provider_Access ADD COLUMN AIG_Prompt_Config_ID NUMERIC(10) DEFAULT NULL 
;
...
INSERT INTO t_alter_column values('aig_provider_access','AIG_Provider_ID','NUMERIC(10)',null,'NULL')
;

-- Mar 12, 2026, 10:49:40 AM CET
INSERT INTO t_alter_column values('aig_provider_access','AIG_Provider_ID',null,'NULL',null)
;
...
INSERT INTO t_alter_column values('aig_prompt_config','AIG_Prompt_Config_ID','NUMERIC(10)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','AIGPromptKey','VARCHAR(40)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','AD_Client_ID','NUMERIC(10)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','AD_Org_ID','NUMERIC(10)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','AIG_Prompt_Config_UU','VARCHAR(36)',null,'NULL')
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','Name','VARCHAR(60)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','Description','VARCHAR(1024)',null,'NULL')
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','AIGPromptText','TEXT',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','Created','TIMESTAMP',null,'statement_timestamp()')
;

-- Mar 12, 2026, 10:51:14 AM CET
UPDATE AIG_Prompt_Config SET Created=statement_timestamp() WHERE Created IS NULL
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','CreatedBy','NUMERIC(10)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','Updated','TIMESTAMP',null,'statement_timestamp()')
;

-- Mar 12, 2026, 10:51:14 AM CET
UPDATE AIG_Prompt_Config SET Updated=statement_timestamp() WHERE Updated IS NULL
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','UpdatedBy','NUMERIC(10)',null,null)
;

-- Mar 12, 2026, 10:51:14 AM CET
INSERT INTO t_alter_column values('aig_prompt_config','IsActive','CHAR(1)',null,'Y')
;
...
-- Mar 12, 2026, 10:51:14 AM CET
ALTER TABLE AIG_Prompt_Config ADD COLUMN IsDefault CHAR(1) DEFAULT 'N' CHECK (IsDefault IN ('Y','N')) NOT NULL
;
...
ALTER TABLE AIG_Prompt_Config ADD COLUMN AIGStatus CHAR(1) DEFAULT 'D' NOT NULL
;
