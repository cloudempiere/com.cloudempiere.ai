...
CREATE TABLE AIG_Prompt_Config (
    ...
    AIG_Prompt_Config_ID NUMERIC(10) NOT NULL,
    AIG_Prompt_Config_UU VARCHAR(36) DEFAULT NULL,
    Name VARCHAR(60) NOT NULL,
    Description VARCHAR(255) DEFAULT NULL,
    AIGPromptKey VARCHAR(40) NOT NULL,
    AIGPromptText TEXT NOT NULL,
...
- Keep responses concise but informative',
    TO_TIMESTAMP('2025-11-24 12:00:06','YYYY-MM-DD HH24:MI:SS'),
    100,
    TO_TIMESTAMP('2025-11-24 12:00:06','YYYY-MM-DD HH24:MI:SS'),
    100,
    'Y'
...
-- Nov 24, 2025, 1:54:40 PM CET
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 1134855, statement_timestamp(), 1134855,t.AD_Tree_ID, 800129, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800129)
;
