...
-- Feb 27, 2026, 2:16:20 PM CET
CREATE SEQUENCE AIG_MODELPRICING_SQ INCREMENT 1 MINVALUE 1000000 MAXVALUE 2147483647 START 1000000
;
...
-- Feb 27, 2026, 2:28:09 PM CET
CREATE TABLE AIG_ModelPricing (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, AIG_ModelPricing_ID NUMERIC(10) NOT NULL, AIG_ModelPricing_UU VARCHAR(36) DEFAULT NULL , AIG_Provider_ID NUMERIC(10) DEFAULT NULL , C_Currency_ID NUMERIC(10) NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, InputCostPerMToken NUMERIC DEFAULT 0, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, ModelName VARCHAR(100) DEFAULT NULL , OutputCostPerMToken NUMERIC DEFAULT 0, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, ValidFrom TIMESTAMP NOT NULL, CONSTRAINT AIG_ModelPricing_Key PRIMARY KEY (AIG_ModelPricing_ID), CONSTRAINT AIG_ModelPricing_UU_idx UNIQUE (AIG_ModelPricing_UU))
;
...
-- Feb 27, 2026, 2:28:58 PM CET
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo, AD_TreeNodeMM_UU) SELECT t.AD_Client_ID, 0, 'Y', statement_timestamp(), 1134855, statement_timestamp(), 1134855,t.AD_Tree_ID, 800147, 0, 999, Generate_UUID() FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=800147)
;
