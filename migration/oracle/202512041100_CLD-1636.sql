...
CREATE SEQUENCE AIG_ChatOwnership_Seq INCREMENT BY 1 MINVALUE 1000000 MAXVALUE 2147483647 START WITH 1000000;

-- Create the AIG_ChatOwnership table
CREATE TABLE AIG_ChatOwnership (
    AIG_ChatOwnership_ID    NUMBER(10,0) NOT NULL,
    AIG_ChatOwnership_UU    VARCHAR2(36) DEFAULT NULL,
    ...
    CM_Chat_ID              NUMBER(10,0) NOT NULL,
    AD_User_ID              NUMBER(10,0) DEFAULT NULL,
    AD_Role_ID              NUMBER(10,0) DEFAULT NULL,
    -- OwnershipType: O=Owner, R=Read, W=Write
    OwnershipType           CHAR(1) DEFAULT 'R' NOT NULL CHECK (OwnershipType IN ('O','R','W')),
    SharedBy_User_ID        NUMBER(10,0) DEFAULT NULL,
...
CREATE UNIQUE INDEX AIG_ChatOwnership_UU_idx ON AIG_ChatOwnership(AIG_ChatOwnership_UU);
