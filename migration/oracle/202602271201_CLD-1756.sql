...
ALTER TABLE AD_Role ADD AIAccessLevel CHAR(1) DEFAULT 'N' NOT NULL
;
...
-- Feb 27, 2026, 12:05:53 PM CET
CREATE SEQUENCE AIG_PROVIDER_ACCESS_SQ INCREMENT BY 1 MINVALUE 1000000 MAXVALUE 2147483647 START WITH 1000000
;
...
-- Feb 27, 2026, 12:12:38 PM CET
CREATE TABLE AIG_Provider_Access (AD_Client_ID NUMBER(10) NOT NULL, AD_Org_ID NUMBER(10) NOT NULL, AD_Role_ID NUMBER(10) DEFAULT NULL , AD_User_ID NUMBER(10) DEFAULT NULL , AIG_Provider_Access_ID NUMBER(10) NOT NULL, AIG_Provider_Access_UU VARCHAR2(36 CHAR) DEFAULT NULL , AIG_Provider_ID NUMBER(10) NOT NULL, Created DATE NOT NULL, CreatedBy NUMBER(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Updated DATE NOT NULL, UpdatedBy NUMBER(10) NOT NULL, CONSTRAINT AIG_Provider_Access_Key PRIMARY KEY (AIG_Provider_Access_ID), CONSTRAINT AIG_Provider_Access_UU_idx UNIQUE (AIG_Provider_Access_UU))
;
