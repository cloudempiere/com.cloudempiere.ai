...
/** Generated Interface for AIG_Prompt_Config
 *  @author iDempiere (generated) 
 *  @version Release 10
 */
@SuppressWarnings("all")
public interface I_AIG_Prompt_Config 
{

    /** TableName=AIG_Prompt_Config */
    public static final String Table_Name = "AIG_Prompt_Config";

    /** AD_Table_ID=800204 */
    public static final int Table_ID = 800204;
    ...
    /** Column name AIG_Prompt_Config_UU */
    public static final String COLUMNNAME_AIG_Prompt_Config_UU = "AIG_Prompt_Config_UU";
    ...
    /** Column name AIGPromptKey */
    public static final String COLUMNNAME_AIGPromptKey = "AIGPromptKey";
    ...
    /** Column name AIGPromptText */
    public static final String COLUMNNAME_AIGPromptText = "AIGPromptText";
