...
/** Generated Interface for AIG_ChatOwnership
 *  @author iDempiere (generated) 
 *  @version Release 10
 */
@SuppressWarnings("all")
public interface I_AIG_ChatOwnership 
{

    /** TableName=AIG_ChatOwnership */
    public static final String Table_Name = "AIG_ChatOwnership";

    /** AD_Table_ID=800207 */
    public static final int Table_ID = 800207;
    ...
    /** Column name AIG_ChatOwnership_ID */
    public static final String COLUMNNAME_AIG_ChatOwnership_ID = "AIG_ChatOwnership_ID";
    ...
    /** Column name AIG_ChatOwnership_UU */
    public static final String COLUMNNAME_AIG_ChatOwnership_UU = "AIG_ChatOwnership_UU";
    ...
    /** Column name SharedBy_User_ID */
    public static final String COLUMNNAME_SharedBy_User_ID = "SharedBy_User_ID";
